...
- Use when the task matches: Design secure CI/CD pipelines with quality gates, environments, provenance, and rollback.
...
Use CRUXIDE Skills Manager and select **CRUX CI/CD**, the target agent, and Project Local, Project Shared, or User scope. Manual installation copies this folder into the agent's supported skills directory.
