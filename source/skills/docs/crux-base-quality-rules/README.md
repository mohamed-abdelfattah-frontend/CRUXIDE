...
- Use when the task matches: Optional baseline rules for readable, typed, maintainable, and verifiable code.
...
Use CRUXIDE Skills Manager and select **CRUX Base Code Quality Rules**, the target agent, and Project Local, Project Shared, or User scope. Manual installation copies this folder into the agent's supported skills directory.
