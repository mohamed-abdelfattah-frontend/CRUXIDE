...
- Use when the task matches: Apply production React and Next.js performance guidance maintained by Vercel.
...
```text
npx -y skills add vercel-labs/agent-skills --skill react-best-practices --agent {agent}
```
