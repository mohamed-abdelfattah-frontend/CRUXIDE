...
- Use when the task matches: Guide native iOS applications using Swift, SwiftUI, structured concurrency, and platform security.
...
Use CRUXIDE Skills Manager and select **CRUX iOS & Swift**, the target agent, and Project Local, Project Shared, or User scope. Manual installation copies this folder into the agent's supported skills directory.
