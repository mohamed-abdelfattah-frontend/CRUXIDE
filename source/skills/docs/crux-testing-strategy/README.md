...
- Use when the task matches: Select proportionate unit, integration, contract, component, and end-to-end testing.
...
Use CRUXIDE Skills Manager and select **CRUX Testing Strategy**, the target agent, and Project Local, Project Shared, or User scope. Manual installation copies this folder into the agent's supported skills directory.
