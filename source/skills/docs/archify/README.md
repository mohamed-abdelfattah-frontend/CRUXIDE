...
- Use when the task matches: Create validated interactive architecture, workflow, sequence, data-flow, and lifecycle maps.
...
```text
npx -y skills add tt-a1i/archify --skill archify --agent {agent}
```
