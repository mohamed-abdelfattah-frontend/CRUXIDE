...
- Use when the task matches: Guide FastAPI, Django, and Python services with explicit contracts, async boundaries, security, persistence, and testing.
...
Use CRUXIDE Skills Manager and select **CRUX Python Backend**, the target agent, and Project Local, Project Shared, or User scope. Manual installation copies this folder into the agent's supported skills directory.
