...
- Use when the task matches: Senior technical-lead rules for scope, engineering decisions, delivery, review, evidence, and team maintainability.
...
Use CRUXIDE Skills Manager and select **CRUX Senior Technical Lead Rules**, the target agent, and Project Local, Project Shared, or User scope. Manual installation copies this folder into the agent's supported skills directory.
