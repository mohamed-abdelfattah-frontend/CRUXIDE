...
- Use when the task matches: Build typed, reproducible, secure Python AI and data workflows with bounded resources, evaluation, and observability.
...
Use CRUXIDE Skills Manager and select **CRUX Python AI Engineering**, the target agent, and Project Local, Project Shared, or User scope. Manual installation copies this folder into the agent's supported skills directory.
