...
- Use when the task matches: ORM rules for explicit mappings, query behavior, transactions, migrations, security, performance, and database-native escape hatches.
...
Use CRUXIDE Skills Manager and select **CRUX ORM & Data Access Rules**, the target agent, and Project Local, Project Shared, or User scope. Manual installation copies this folder into the agent's supported skills directory.
