...
- Use when the task matches: Build Express services with explicit middleware order, validation, security, and service boundaries.
...
Use CRUXIDE Skills Manager and select **CRUX Express Architecture**, the target agent, and Project Local, Project Shared, or User scope. Manual installation copies this folder into the agent's supported skills directory.
