...
- Use when the task matches: Build practical threat models tied to concrete system components and mitigations.
...
Use CRUXIDE Skills Manager and select **CRUX Threat Modeling**, the target agent, and Project Local, Project Shared, or User scope. Manual installation copies this folder into the agent's supported skills directory.
