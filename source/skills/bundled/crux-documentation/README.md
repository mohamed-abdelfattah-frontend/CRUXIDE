...
- Use when the task matches: Create accurate READMEs, runbooks, handovers, API guides, and architecture documentation.
...
Use CRUXIDE Skills Manager and select **CRUX Documentation**, the target agent, and Project Local, Project Shared, or User scope. Manual installation copies this folder into the agent's supported skills directory.
