...
- Use when the task matches: Reason about consistency, queues, retries, caching, idempotency, and service failure.
...
Use CRUXIDE Skills Manager and select **CRUX Distributed Systems**, the target agent, and Project Local, Project Shared, or User scope. Manual installation copies this folder into the agent's supported skills directory.
