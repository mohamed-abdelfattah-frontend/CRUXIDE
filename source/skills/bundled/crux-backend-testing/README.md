...
- Use when the task matches: Build proportionate backend test suites across domain, services, databases, queues, and APIs.
...
Use CRUXIDE Skills Manager and select **CRUX Backend Testing**, the target agent, and Project Local, Project Shared, or User scope. Manual installation copies this folder into the agent's supported skills directory.
