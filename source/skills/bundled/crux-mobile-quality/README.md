...
- Use when the task matches: Review cross-platform mobile apps for accessibility, offline resilience, security, and device performance.
...
Use CRUXIDE Skills Manager and select **CRUX Mobile Quality**, the target agent, and Project Local, Project Shared, or User scope. Manual installation copies this folder into the agent's supported skills directory.
