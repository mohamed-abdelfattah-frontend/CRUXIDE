...
- Use when the task matches: Structure enterprise frontends around feature boundaries, predictable data flow, and reusable platform services.
...
Use CRUXIDE Skills Manager and select **CRUX Frontend Architecture**, the target agent, and Project Local, Project Shared, or User scope. Manual installation copies this folder into the agent's supported skills directory.
