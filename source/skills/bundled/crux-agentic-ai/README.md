...
- Use when the task matches: Design bounded agents with explicit tools, permissions, state, approvals, and evaluation.
...
Use CRUXIDE Skills Manager and select **CRUX Agentic AI**, the target agent, and Project Local, Project Shared, or User scope. Manual installation copies this folder into the agent's supported skills directory.
