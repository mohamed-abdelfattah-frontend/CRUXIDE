...
- Use when the task matches: Production AI rules for evaluations, permissions, retrieval, prompt injection, tools, privacy, cost, observability, and human control.
...
Use CRUXIDE Skills Manager and select **CRUX AI, Agents & RAG Production Rules**, the target agent, and Project Local, Project Shared, or User scope. Manual installation copies this folder into the agent's supported skills directory.
