...
- Use when the task matches: Design and review MongoDB, Redis, and other NoSQL systems around access patterns, consistency, scale, security, and recovery.
...
Use CRUXIDE Skills Manager and select **CRUX NoSQL Database Engineering**, the target agent, and Project Local, Project Shared, or User scope. Manual installation copies this folder into the agent's supported skills directory.
